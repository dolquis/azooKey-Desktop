...
3. C++ の package identity、TIP 登録、AppContainer 境界へ影響する場合は、CodeGraph で経路を確認し、Serena で対象シンボルと参照元を確認する。
4. XML、PowerShell、workflow、長い diff やログは Context-Mode で整理する。
