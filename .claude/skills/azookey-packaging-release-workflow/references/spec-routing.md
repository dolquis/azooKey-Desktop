...
| MSIX 更新、rollback、登録 lifecycle | `compat-test/msix_install_uninstall.ps1`（`compat-test/` は M50 のアプリ互換性テストハーネスと同居） | `scripts/tests/msix-lifecycle-scenarios.Tests.ps1`、許可された VM smoke |
